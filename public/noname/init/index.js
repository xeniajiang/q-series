...
async function boot() {
  ...
  await loadConfig();
	// Migrate the former bundled default to Taoyuan while preserving any
	// background a player explicitly selected themselves.
	if (["default", "noname_bg"].includes(get$1("image_background"))) {
		set("image_background", "taoyuan_bg");
		game.saveConfig("image_background", "taoyuan_bg");
	}
