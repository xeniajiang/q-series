...
import { pinyin, convert, addDict } from "../../vendor/pnpm/pinyin-pro@3.28.0/modules/pinyin-pro/dist/index.js";
...
${str}`);
  ...
  *iterableChildNodes(...elements) {
  ...
  static #cardProperFunctions = /* @__PURE__ */ new Set(["name", "type", "subtype", "color", "suit", "number"]);
  /**
   * 将过滤函数或对象条件标准化为过滤函数。
   *
  ...
  skinPath(name) {
    ...
    let src, ext = ".jpg", subfolder = "default";
    let dbimage = null, extimage = null, modeimage = null, nameinfo = get.character(name), gzbool = false;
