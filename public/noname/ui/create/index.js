...
class Create {
  ...
  async editor(config = {}) {
    ...
    const { basicSetup } = await __vitePreload(async () => {
      const { basicSetup: basicSetup2 } = await import("../../../node_modules/.pnpm/codemirror@6.0.2/node_modules/codemirror/dist/index.js");
    ...
    const { EditorView } = await __vitePreload(async () => {
      const { EditorView: EditorView2 } = await import("../../../node_modules/.pnpm/@codemirror_view@6.39.14/node_modules/@codemirror/view/dist/index.js");
    ...
    const { linter, lintGutter } = await __vitePreload(async () => {
      const { linter: linter2, lintGutter: lintGutter2 } = await import("../../../node_modules/.pnpm/@codemirror_lint@6.9.4/node_modules/@codemirror/lint/dist/index.js");
    ...
    const { search, highlightSelectionMatches, openSearchPanel } = await __vitePreload(async () => {
      const { search: search2, highlightSelectionMatches: highlightSelectionMatches2, openSearchPanel: openSearchPanel2 } = await import("../../../node_modules/.pnpm/@codemirror_search@6.6.0/node_modules/@codemirror/search/dist/index.js");
    ...
    if (language === "javascript" || language === "typescript") {
      const { javascript, scopeCompletionSource, javascriptLanguage, esLint } = await __vitePreload(async () => {
        const { javascript: javascript2, scopeCompletionSource: scopeCompletionSource2, javascriptLanguage: javascriptLanguage2, esLint: esLint2 } = await import("../../../node_modules/.pnpm/@codemirror_lang-javascript@6.2.4/node_modules/@codemirror/lang-javascript/dist/index.js");
      ...
      if (language === "javascript") {
        const { Linter } = await __vitePreload(async () => {
          const { Linter: Linter2 } = await import("../../../node_modules/.pnpm/eslint-linter-browserify@9.39.2/node_modules/eslint-linter-browserify/linter.js");
      ...
      const { css } = await __vitePreload(async () => {
        const { css: css2 } = await import("../../../node_modules/.pnpm/@codemirror_lang-css@6.3.1/node_modules/@codemirror/lang-css/dist/index.js");
        return { css: css2 };
      ...
      const { json, jsonParseLinter } = await __vitePreload(async () => {
        const { json: json2, jsonParseLinter: jsonParseLinter2 } = await import("../../../node_modules/.pnpm/@codemirror_lang-json@6.0.2/node_modules/@codemirror/lang-json/dist/index.js");
      ...
      const { html } = await __vitePreload(async () => {
        const { html: html2 } = await import("../../../node_modules/.pnpm/@codemirror_lang-html@6.4.11/node_modules/@codemirror/lang-html/dist/index.js");
        return { html: html2 };
      ...
      const { parser: htmlParser } = await __vitePreload(async () => {
        const { parser: htmlParser2 } = await import("../../../node_modules/.pnpm/@lezer_html@1.3.13/node_modules/@lezer/html/dist/index.js");
      ...
      const { parser: jsParser } = await __vitePreload(async () => {
        const { parser: jsParser2 } = await import("../../../node_modules/.pnpm/@lezer_javascript@1.5.4/node_modules/@lezer/javascript/dist/index.js");
        return { parser: jsParser2 };
      }, true ? __vite__mapDeps([15,16,8,9]) : void 0, import.meta.url);
      const { parseMixed } = await __vitePreload(async () => {
        const { parseMixed: parseMixed2 } = await import("../../../node_modules/.pnpm/@lezer_common@1.5.1/node_modules/@lezer/common/dist/index.js");
        return { parseMixed: parseMixed2 };
      }, true ? [] : void 0, import.meta.url);
      const { LRLanguage } = await __vitePreload(async () => {
        const { LRLanguage: LRLanguage2 } = await import("../../../node_modules/.pnpm/@codemirror_language@6.12.1/node_modules/@codemirror/language/dist/index.js");
      ...
      const { markdown } = await __vitePreload(async () => {
        const { markdown: markdown2 } = await import("../../../node_modules/.pnpm/@codemirror_lang-markdown@6.5.0/node_modules/@codemirror/lang-markdown/dist/index.js");
      ...
      const { vue } = await __vitePreload(async () => {
        const { vue: vue2 } = await import("../../../node_modules/.pnpm/@codemirror_lang-vue@0.1.3/node_modules/@codemirror/lang-vue/dist/index.js");
        return { vue: vue2 };
